...
class AdminViewController: UIViewController {
    ...
    //Using Segues from storyboard for button actions.
    //Here we only style
    ...
    func populateDataForTesting() {
        ...
        db.insertQuizSessions(userId: 9, score: 4, sessionDate: "Mar-17-2022", subjectName: "Math")
        db.insertQuizSessions(userId: 9, score: 4, sessionDate: "Mar-17-2022", subjectName: "English")
        db.insertQuizSessions(userId: 9, score: 4, sessionDate: "Mar-17-2022", subjectName: "Science")
        db.insertQuizSessions(userId: 9, score: 4, sessionDate: "Mar-17-2022", subjectName: "Science")
        db.insertQuizSessions(userId: 9, score: 4, sessionDate: "Mar-17-2022", subjectName: "Math")
